        ...
        <div class="homepage-wrapper">
            ...
            <div class="homepage-inner">
                <ul class="homepage-menu row justify-content-center">
                    <li class="col-5">
                        <a class="homepage-menu-item big" href="{{ url('/sibima/sikombatan') }}">
                    ...
                    <li class="col-5">
                        <a class="homepage-menu-item big" href="{{ url('/sibima/sikalan') }}">
                            <div class="homepage-menu-item-text">
                ...
                <ul class="homepage-menu row justify-content-center">
                    <li class="col-3">
                        <a class="homepage-menu-item" href="{{ url('/sibima/profil') }}">
                            <div class="homepage-menu-item-text">
                    ...
                    <li class="col-3">
                        <a class="homepage-menu-item" href="{{ url('/sibima/artikel') }}">
                            <div class="homepage-menu-item-text">
                    ...
                    <li class="col-3">
                        <a class="homepage-menu-item" href="{{ url('/sibima/galery') }}">
                            <div class="homepage-menu-item-text">
                    ...
                    <li class="col-3">
                        <a class="homepage-menu-item" href="{{ url('/sibima/bilik-laporan') }}">
                            <div class="homepage-menu-item-text">
