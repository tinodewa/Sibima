    ...
    <div class="container container-login animated fadeIn">
        ...
        <div class="login-form">
            ...
            <div class="form-group form-floating-label">
                <input id="username" name="username" type="text" class="form-control input-border-bottom" value="{{ old('username') }}" required autofocus>
            ...
            <div class="form-action">
                <button type="submit" class="btn btn-primary btn-rounded btn-login" style="cursor:pointer;">Sign In</button>
            </div>
            </form>
    </div>
    </div>
